...
public interface IContractRepository extends JpaRepository<Contracts, Long> {
    ...
    void deleteContractById(@Param("id") Integer id);
        ...
        @Query(value = "INSERT INTO contracts(customer_id,contract_code,product_name,product_type_id,image,loans,start_date,end_date,profit,contract_status_id,contract_type_id,employee_id) " +
                "VALUES (:customers,:contractCode,:productName,:productType,:image,:loans,:startDate,:endDate,:profit,:contractStatus,:contractType,:employees)", nativeQuery = true)
        void createContract(@Param("customers") Long customers, @Param("contractCode") String contractCode,
                            ...
                            @Param("endDate") String endDate, @Param("profit") Long profit, @Param("contractStatus") Long contractStatus,
                            @Param("contractType") Long contractType, @Param("employees") Long employees);
